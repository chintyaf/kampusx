...
class EventSeeder2 extends Seeder
{
    public function run(): void
    {
        ...
        $eventsData = [
            ...
            [
                ...
                'sessions'   => [
                    ...
                    [
                        'title'       => 'Panel Diskusi: Generative AI di Sektor Publik',
                        'description' => 'Diskusi mendalam mengenai pemanfaatan LLM untuk pelayanan publik.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->subDays(1)->toDateString(),
                        'start_time'  => '10:30:00',
                        'end_time'    => '12:00:00',
                    ...
                    [
                        'title'       => 'Workshop: Fine-Tuning LLM Bahasa Indonesia',
                        'description' => 'Sesi hands-on melatih model lokal dengan dataset spesifik.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->subDays(1)->toDateString(),
                        'start_time'  => '13:30:00',
                        'end_time'    => '16:00:00',
                    ...
                    [
                        'title'       => 'Keynote Day 2: Etika & Regulasi AI di Asia Tenggara',
                        'description' => 'Memahami kebijakan privasi, kepemilikan data, dan tata kelola AI.',
                        'day_number'  => 2,
                        'date'        => Carbon::now()->toDateString(),
                        'start_time'  => '09:00:00',
                        'end_time'    => '10:30:00',
                        'speakers'    => [
                            ['name' => 'Prof. Hermawan', 'role' => 'Tech Ethics Advocate', 'bio' => 'Peneliti senior regulasi digital.', 'expertise' => ['AI Ethics', 'Cyber Law']],
                        ],
                    ],
                    [
                        'title'       => 'Sesi Paralel: AI di Bidang Kesehatan & MedTech',
                        'description' => 'Penerapan visi komputer untuk analisis citra medis.',
                        'day_number'  => 2,
                        'date'        => Carbon::now()->toDateString(),
                        'start_time'  => '11:00:00',
                        'end_time'    => '12:30:00',
                    ...
                    [
                        'title'       => 'Networking Session & Exhibition',
                        'description' => 'Waktu luang untuk berjejaring dan mengunjungi booth teknologi.',
                        'day_number'  => 2,
                        'date'        => Carbon::now()->toDateString(),
                        'start_time'  => '13:30:00',
                        'end_time'    => '16:30:00',
                    ...
                    [
                        'title'       => 'Keynote Day 3: Computer Vision & Robotika',
                        'description' => 'Perkembangan robot otonom dan pengenalan visual tingkat lanjut.',
                        'day_number'  => 3,
                    ...
                    [
                        ...
                        'description' => 'Penutupan rangkaian summit dan pengumuman pemenang pameran AI.',
                        'day_number'  => 3,
                        'date'        => Carbon::now()->addDays(1)->toDateString(),
                        'start_time'  => '11:00:00',
                        'end_time'    => '13:00:00',
                ...
                'tickets'        => [
                    ['name' => 'Early Bird Pass (Online)', 'type' => 'online',  'price' => 100000,  'capacity' => 200, 'sale_start' => Carbon::now()->subDays(10), 'sale_end' => Carbon::now()->addDays(5)],
                    ['name' => 'Regular Pass (Online)', 'type' => 'online',  'price' => 150000,  'capacity' => 1000, 'sale_start' => Carbon::now()->subDays(10), 'sale_end' => Carbon::now()->addDays(28)],
                    ['name' => 'VIP Pass (Online)', 'type' => 'online',  'price' => 300000,  'capacity' => 100, 'sale_start' => Carbon::now()->subDays(10), 'sale_end' => Carbon::now()->addDays(28)],
                    ['name' => 'Regular Pass (Offline)', 'type' => 'offline', 'price' => 750000,  'capacity' => 300, 'sale_start' => Carbon::now()->subDays(10), 'sale_end' => Carbon::now()->addDays(25)],
                    ['name' => 'VIP Pass (Offline)', 'type' => 'offline', 'price' => 1500000,  'capacity' => 50, 'sale_start' => Carbon::now()->subDays(10), 'sale_end' => Carbon::now()->addDays(25)],
                ],
                'collaborators'  => [
            ...
            [
                ...
                'sessions'   => [
                    [
                        'title'       => 'Sesi Utama: Pitching & Funding',
                        'description' => 'Sesi pemaparan materi pendanaan startup.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->addDays(14)->toDateString(),
                        'start_time'  => '09:00:00',
                        'end_time'    => '11:00:00',
                        'speakers'    => [
                            ['name' => 'Andi Wijaya', 'role' => 'Venture Capital Partner', 'bio' => 'Investor and startup advisor.', 'expertise' => ['Startup Funding', 'Pitching']],
                        ],
                    ],
                    [
                        'title'       => 'Sesi Q&A & Mentoring Ringkas',
                        'description' => 'Tanya jawab interaktif dan bedah pitch deck terpilih.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->addDays(14)->toDateString(),
                        'start_time'  => '11:00:00',
                        'end_time'    => '12:30:00',
                ...
                'tickets'        => [
                    ['name' => 'Early Bird', 'type' => 'online', 'price' => 35000, 'capacity' => 100, 'sale_start' => Carbon::now()->subDays(5), 'sale_end' => Carbon::now()->addDays(2)],
                    ['name' => 'Regular Pass', 'type' => 'online', 'price' => 50000, 'capacity' => 1000, 'sale_start' => Carbon::now()->subDays(5), 'sale_end' => Carbon::now()->addDays(13)],
                    ['name' => 'VIP Pass + Pitch Deck Kit', 'type' => 'online', 'price' => 100000, 'capacity' => 150, 'sale_start' => Carbon::now()->subDays(5), 'sale_end' => Carbon::now()->addDays(13)],
                ],
                'collaborators' => [
            ...
            [
                ...
                'sessions'   => [
                    [
                        'title'       => 'Opening Ceremony & Team Matching',
                        'description' => 'Pembukaan HackBandung 2025 dan pencocokan tim akhir.',
                        'day_number'  => 1,
                    ...
                    [
                        'title'       => 'Hacking Kickoff & Mentoring Sesi 1',
                        'description' => 'Mulainya pengerjaan proyek dan konsultasi dengan mentor.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->addDays(45)->toDateString(),
                        'start_time'  => '10:30:00',
                        'end_time'    => '17:00:00',
                    ...
                    [
                        'title'       => 'Final Pitching & Demoday',
                        'description' => 'Presentasi karya di hadapan dewan juri.',
                        'day_number'  => 2,
                    ...
                    [
                        ...
                        'description' => 'Pengumuman pemenang HackBandung 2025 dan penutupan.',
                        'day_number'  => 2,
                        'date'        => Carbon::now()->addDays(46)->toDateString(),
                        'start_time'  => '14:30:00',
                        'end_time'    => '17:00:00',
                ...
                'tickets'        => [
                    ['name' => 'Student Pass', 'type' => 'offline', 'price' => 120000, 'capacity' => 50, 'sale_start' => Carbon::now()->subDays(20), 'sale_end' => Carbon::now()->addDays(40)],
                    ['name' => 'General Pass', 'type' => 'offline', 'price' => 200000, 'capacity' => 150, 'sale_start' => Carbon::now()->subDays(20), 'sale_end' => Carbon::now()->addDays(40)],
                    ['name' => 'VIP Team Pass', 'type' => 'offline', 'price' => 500000, 'capacity' => 30, 'sale_start' => Carbon::now()->subDays(20), 'sale_end' => Carbon::now()->addDays(40)],
                ],
                'collaborators' => [
                    ['institution' => 1, 'role' => 'co_host'],
                ],
            ...
            [
                ...
                'sessions'   => [
                    [
                        'title'       => 'Materi Pengenalan UI/UX & Wireframing',
                        'description' => 'Sesi pembuka bootcamp mengenai dasar-dasar UX dan pembuatan wireframe.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->subDays(10)->toDateString(),
                        'start_time'  => '10:00:00',
                        'end_time'    => '12:00:00',
                        'speakers'    => [
                            ['name' => 'Rian Pratama', 'role' => 'Lead UI/UX Designer', 'bio' => 'Designer at TechCorp.', 'expertise' => ['Figma', 'UI Design']],
                        ],
                    ],
                    [
                        'title'       => 'Figma Intermediate: Component & Auto Layout',
                        'description' => 'Materi praktek Figma untuk membuat desain sistem dan auto layout.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->subDays(10)->toDateString(),
                        'start_time'  => '13:00:00',
                        'end_time'    => '15:00:00',
                    ...
                    [
                        ...
                        'description' => 'Praktek membuat alur prototipe interaktif dan melakukan testing awal.',
                        'day_number'  => 2,
                    ...
                    [
                        'title'       => 'Portfolio Review & Closing',
                        'description' => 'Review hasil kerja bootcamp oleh mentor senior.',
                        'day_number'  => 2,
                        'date'        => Carbon::now()->subDays(9)->toDateString(),
                        'start_time'  => '13:00:00',
                        'end_time'    => '16:00:00',
                ...
                'tickets'        => [
                    ['name' => 'Regular Entry', 'type' => 'online', 'price' => 195000, 'capacity' => 100, 'sale_start' => Carbon::now()->subDays(15), 'sale_end' => Carbon::now()->subDays(8)],
                    ['name' => 'VIP Entry + Portofolio Review', 'type' => 'online', 'price' => 395000, 'capacity' => 20, 'sale_start' => Carbon::now()->subDays(15), 'sale_end' => Carbon::now()->subDays(8)],
                ],
                'collaborators' => [
            ...
            [
                ...
                'sessions'   => [
                    [
                        'title'       => 'Senam Pagi & Yoga Massal',
                        'description' => 'Sesi senam pagi bersama instruktur profesional dan kelas yoga.',
                        'day_number'  => 1,
                    ...
                    [
                        'title'       => 'Talkshow Kesehatan Mental & Nutrisi',
                        'description' => 'Diskusi panel pentingnya nutrisi seimbang untuk kesejahteraan mental.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->subDays(5)->toDateString(),
                        'start_time'  => '13:00:00',
                        'end_time'    => '15:00:00',
                        'speakers'    => [
                            ['name' => 'Siti Aminah', 'role' => 'Clinical Psychologist & Nutritionist', 'bio' => 'Pakar kesehatan holistik.', 'expertise' => ['Mental Health', 'Nutrition']],
                        ],
                    ],
                    [
                        'title'       => 'Cardio Dance & Zumba Party',
                        'description' => 'Sesi kebugaran aerobik intensitas tinggi yang menyenangkan.',
                        'day_number'  => 2,
                    ...
                    [
                        'title'       => 'Healthy Cooking Demo & Closing',
                        'description' => 'Demo memasak makanan sehat praktis dan murah.',
                        'day_number'  => 2,
                        'date'        => Carbon::now()->subDays(4)->toDateString(),
                        'start_time'  => '13:00:00',
                        'end_time'    => '15:00:00',
                        'speakers'    => [
                            ['name' => 'Chef Arnold', 'role' => 'Professional Chef', 'bio' => 'Spesialis makanan sehat.', 'expertise' => ['Healthy Cooking']],
                        ],
                    ],
                ],
                'tickets'        => [
                    ['name' => 'General Admission (Free)', 'type' => 'offline', 'price' => 0, 'capacity' => 5000, 'sale_start' => Carbon::now()->subDays(15), 'sale_end' => Carbon::now()->subDays(4)],
                    ['name' => 'VIP Pass (Includes T-Shirt)', 'type' => 'offline', 'price' => 100000, 'capacity' => 200, 'sale_start' => Carbon::now()->subDays(15), 'sale_end' => Carbon::now()->subDays(4)],
                ],
                'collaborators' => [
            ...
            [
                ...
                'sessions'   => [
                    [
                        'title'       => 'Pengenalan Biji Kopi & Teori Roasting',
                        'description' => 'Mengenal origin biji kopi nusantara dan teori dasar pemanggangan.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->subDays(2)->toDateString(),
                        'start_time'  => '10:00:00',
                        'end_time'    => '12:00:00',
                        'speakers'    => [
                            ['name' => 'Hendra Setiawan', 'role' => 'Certified Master Roaster', 'bio' => 'Roaster at Kopi Kini.', 'expertise' => ['Coffee Roasting', 'Cupping']],
                        ],
                    ],
                    [
                        'title'       => 'Praktek Roasting Kopi',
                        'description' => 'Peserta akan langsung mempraktekkan teknik roasting menggunakan mesin.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->subDays(2)->toDateString(),
                        'start_time'  => '13:00:00',
                        'end_time'    => '16:00:00',
                    ...
                    [
                        ...
                        'description' => 'Evaluasi hasil roasting dengan cupping standar industri.',
                        'day_number'  => 2,
                        'date'        => Carbon::now()->subDays(1)->toDateString(),
                        'start_time'  => '10:00:00',
                        'end_time'    => '13:00:00',
                ...
                'tickets'        => [
                    ['name' => 'Regular Roaster Pass', 'type' => 'offline', 'price' => 350000, 'capacity' => 20, 'sale_start' => Carbon::now()->subDays(2), 'sale_end' => Carbon::now()->addDays(8)],
                    ['name' => 'VIP Roaster + Coffee Bean Pack', 'type' => 'offline', 'price' => 500000, 'capacity' => 10, 'sale_start' => Carbon::now()->subDays(2), 'sale_end' => Carbon::now()->addDays(8)],
                ],
                'collaborators' => [],
            ],
            ...
            [
                ...
                'sessions'   => [
                    [
                        ...
                        'end_time'    => '21:00:00',
                        'speakers'    => [
                            ['name' => 'Sarah Connor', 'role' => 'English Instructor', 'bio' => 'Professional ESL tutor.', 'expertise' => ['English', 'Technical Writing']],
                        ],
                    ],
                    [
                        'title'       => 'Writing Code Comments & Documentation',
                        'description' => 'Teknik menulis deskripsi dan dokumentasi teknis yang jelas.',
                        'day_number'  => 2,
                    ...
                    [
                        'title'       => 'Daily Standup Mocking & Effective Communication',
                        'description' => 'Latihan simulasi rapat harian (scrum) menggunakan Bahasa Inggris.',
                        'day_number'  => 3,
                    ...
                    [
                        'title'       => 'Code Review Argumentation & Final Assessment',
                        'description' => 'Latihan memberikan argumen dan feedback saat code review.',
                        'day_number'  => 4,
                ...
                'tickets'        => [
                    ['name' => 'Student Tech Pass', 'type' => 'online', 'price' => 300000, 'capacity' => 30, 'sale_start' => Carbon::now()->subDays(10), 'sale_end' => Carbon::now()->addDays(4)],
                    ['name' => 'Regular Tech Pass', 'type' => 'online', 'price' => 450000, 'capacity' => 50, 'sale_start' => Carbon::now()->subDays(10), 'sale_end' => Carbon::now()->addDays(4)],
                    ['name' => 'Corporate Tech Pass', 'type' => 'online', 'price' => 800000, 'capacity' => 20, 'sale_start' => Carbon::now()->subDays(10), 'sale_end' => Carbon::now()->addDays(4)],
                ],
                'collaborators' => [],
            ],
            ...
            [
                ...
                'sessions'   => [
                    [
                        ...
                        'end_time'    => '12:00:00',
                        'speakers'    => [
                            ['name' => 'Ir. Joko Susilo', 'role' => 'Energy Consultant', 'bio' => 'Pakar energi terbarukan.', 'expertise' => ['Green Energy', 'Solar Power']],
                        ],
                    ],
                    [
                        'title'       => 'Sesi Q&A & Diskusi Interaktif',
                        'description' => 'Tanya jawab interaktif pemirsa daring dan luring.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->addDays(60)->toDateString(),
                        'start_time'  => '13:30:00',
                        'end_time'    => '15:30:00',
                ...
                'tickets'        => [
                    ['name' => 'Free Online Pass', 'type' => 'online', 'price' => 0, 'capacity' => 2000, 'sale_start' => Carbon::now()->addDays(10), 'sale_end' => Carbon::now()->addDays(59)],
                    ['name' => 'Regular Offline Pass', 'type' => 'offline', 'price' => 150000, 'capacity' => 200, 'sale_start' => Carbon::now()->addDays(10), 'sale_end' => Carbon::now()->addDays(50)],
                    ['name' => 'VIP Offline Pass + Networking Dinner', 'type' => 'offline', 'price' => 400000, 'capacity' => 50, 'sale_start' => Carbon::now()->addDays(10), 'sale_end' => Carbon::now()->addDays(50)],
                ],
                'collaborators' => [
                    ['institution' => 2, 'role' => 'sponsor'],
                ],
            ...
            [
                ...
                'sessions'   => [
                    [
                        ...
                        'description' => 'Sesi teori pertolongan pertama pada kecelakaan.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->addDays(18)->toDateString(),
                        'start_time'  => '08:00:00',
                        'end_time'    => '12:00:00',
                        'speakers'    => [
                            ['name' => 'dr. Rina Octora', 'role' => 'Emergency Physician', 'bio' => 'PMI Instructor.', 'expertise' => ['First Aid', 'Basic Life Support']],
                        ],
                    ],
                    [
                        'title'       => 'Praktek Resusitasi Jantung Paru (CPR)',
                        'description' => 'Latihan fisik melakukan CPR dengan boneka phantom.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->addDays(18)->toDateString(),
                        'start_time'  => '13:00:00',
                        'end_time'    => '16:00:00',
                    ...
                    [
                        'title'       => 'Penanganan Luka Bakar & Patah Tulang',
                        'description' => 'Materi teknik pembalutan dan pembidaian darurat.',
                        'day_number'  => 2,
                        'date'        => Carbon::now()->addDays(19)->toDateString(),
                        'start_time'  => '08:00:00',
                        'end_time'    => '12:00:00',
                        'speakers'    => [
                            ['name' => 'dr. Rina Octora', 'role' => 'Emergency Physician', 'bio' => 'PMI Instructor.', 'expertise' => ['First Aid', 'Basic Life Support']],
                    ...
                    [
                        'title'       => 'Evaluasi Akhir & Sertifikasi',
                        'description' => 'Ujian kecakapan praktis penanganan darurat.',
                        'day_number'  => 2,
                        'date'        => Carbon::now()->addDays(19)->toDateString(),
                        'start_time'  => '13:00:00',
                        'end_time'    => '16:00:00',
                ...
                'tickets'        => [
                    ['name' => 'Student BLS Pass', 'type' => 'offline', 'price' => 180000, 'capacity' => 20, 'sale_start' => Carbon::now()->subDays(5), 'sale_end' => Carbon::now()->addDays(15)],
                    ['name' => 'General BLS Pass', 'type' => 'offline', 'price' => 250000, 'capacity' => 40, 'sale_start' => Carbon::now()->subDays(5), 'sale_end' => Carbon::now()->addDays(15)],
                ],
                'collaborators' => [],
            ],
            ...
            [
                ...
                'sessions'   => [
                    [
                        ...
                        'end_time'    => '20:30:00',
                        'speakers'    => [
                            ['name' => 'Gerry Girianza', 'role' => 'Financial Planner', 'bio' => 'Founder of Cerdas Uang.', 'expertise' => ['Stock Market', 'Personal Finance']],
                        ],
                    ],
                    [
                        'title'       => 'Sesi Q&A & Tanya Jawab Interaktif',
                        'description' => 'Konsultasi portofolio investasi pemula.',
                        'day_number'  => 1,
                        'date'        => Carbon::now()->addDays(2)->toDateString(),
                        'start_time'  => '20:30:00',
                        'end_time'    => '21:30:00',
                ...
                'tickets'        => [
                    ['name' => 'Regular Entry', 'type' => 'online', 'price' => 25000, 'capacity' => 500, 'sale_start' => Carbon::now()->subDays(15), 'sale_end' => Carbon::now()->addDays(1)],
                    ['name' => 'VIP Entry + E-Certificate & Materials', 'type' => 'online', 'price' => 75000, 'capacity' => 100, 'sale_start' => Carbon::now()->subDays(15), 'sale_end' => Carbon::now()->addDays(1)],
                ],
                'collaborators' => [],
            ],
        ];
        ...
        foreach ($eventsData as $eventData) {
            ...
            // Calculate quotas dynamically from tickets
            $onlineQuota = 0;
            $offlineQuota = 0;
            $hasOnlineTicket = false;
            $hasOfflineTicket = false;
            foreach ($eventData['tickets'] as $ticket) {
                if ($ticket['type'] === 'online') {
                    $onlineQuota += $ticket['capacity'];
                    $hasOnlineTicket = true;
                } elseif ($ticket['type'] === 'offline') {
                    $offlineQuota += $ticket['capacity'];
                    $hasOfflineTicket = true;
                }
            }
            ...
            DB::table('event_locations')->insert([
                ...
                'online_quota'        => $hasOnlineTicket ? $onlineQuota : null,
                'offline_quota'       => $hasOfflineTicket ? $offlineQuota : null,
                'created_at'          => now(),
                'updated_at'          => now(),
            ]);
