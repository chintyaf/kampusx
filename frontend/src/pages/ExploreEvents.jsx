...
const ExploreEvents = () => {
	...
	const handleDataLocation = (coords) => {
		console.log('Dapat lokasi nih:', coords);
	};
		...
		<>
			...
			<div
				...
				<div className="py-5 bg-white border-bottom mb-4 shadow-sm">
					<Container>
						<h2 className="fw-bold mb-2" style={{ color: 'var(--color-text)' }}>
							Eksplor Event
						</h2>
						<p className="text-muted m-0">
							Temukan event konferensi dan workshop terbaik dari seluruh dunia.
						</p>
					</Container>
				</div>
							...
							<Card className="border-0 shadow-sm" style={{ borderRadius: '10px' }}>
								...
								<Card.Body
									...
									<Form>
										...
										<Button
											className="w-100 fw-bold border-0 py-2 mt-2"
