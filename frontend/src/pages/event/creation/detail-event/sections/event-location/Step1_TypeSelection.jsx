		...
		<Form className="form">
			...
			<div className="mb-4 d-flex align-items-start">
				<div className="d-flex flex-column">
					<p className="form-label required">Tipe Kehadiran</p>
					<span className="text-muted small mb-0">
						Pilih mode kehadiran. Ini menentukan field yang perlu diisi.
					</span>
				</div>
			</div>

			{/* Pilihan Tipe Kehadiran */}
			<TypeCard selectedType={localSelectedType} onSelectType={handleTypeSelection} />
		</Form>
	);
};
