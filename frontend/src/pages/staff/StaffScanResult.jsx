    ...
    return (
        <div style={{ minHeight: '100vh', backgroundColor: isSuccess ? '#f0fdf4' : '#fef2f2', display: 'flex', flexDirection: 'column' }}>
            <div className="flex-grow-1 d-flex flex-column align-items-center justify-content-center p-4 text-center">
                ...
                {feedback.attendee && (
                    <Card className="border-0 shadow-sm rounded-4 w-100" style={{ maxWidth: 400, border: '1px solid var(--color-border, #cbd5e1)' }}>
                        <Card.Body className="p-4 text-start">
                            <div className="d-flex align-items-center gap-3 mb-3 pb-3 border-bottom" style={{ borderColor: 'var(--color-border, #cbd5e1)' }}>
                                <div style={{ width: 48, height: 48, borderRadius: 12, background: 'var(--color-bg-2, #f1f5f9)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <Badge bg="light" text="dark" className="border px-3 py-2 fs-6" style={{ borderColor: 'var(--color-border, #cbd5e1)' }}>{feedback.attendee.code}</Badge>
                            </div>
                        </Card.Body>
                    </Card>
                )}
            ...
            <div className="p-4 bg-white border-top shadow-lg" style={{ borderColor: 'var(--color-border, #cbd5e1)' }}>
                <Button size="lg" className="w-100 rounded-pill fw-bold py-3 border-0 text-white" style={{ backgroundColor: 'var(--color-primary, #00699e)' }} onClick={() => navigate('/staff/dashboard')}>
