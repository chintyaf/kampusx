	...
	return (
		<div className="mb-4">
			...
			<div className="d-flex justify-content-between align-items-center">
				<Form.Label className="required d-flex align-items-center gap-2 fw-bold">
			...
			{!isLocationSelected ? (
				...
				>
					...
					/>
					<div>
						<h6 className="mb-1 fw-bold">Belum ada lokasi yang dipilih</h6>
						<span
							style={{
								fontSize: 'var(--font-sm)',
						...
						>
							Silakan cari lokasi menggunakan kolom pencarian di atas, atau aktifkan
							fitur <strong style={{ color: 'var(--color-text)' }}>Isi Manual</strong>{' '}
