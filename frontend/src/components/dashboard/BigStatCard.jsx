...
const BigStatCard = ({ title, content, subcontent }) => {
	return (
		<div className="card border-grey p-3 d-flex flex-fill" style={{ borderRadius: '7px' }}>
			<div className="card-body ">
				<div className="d-flex justify-content-between align-items-start">
					<div>
						...
						<h2 className="fw-bold mb-0" style={{ fontSize: 'var(--font-xl)' }}>
							{content}
						</h2>
					</div>
