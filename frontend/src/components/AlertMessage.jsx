...
const AlertMessage = ({ t, type, title, message }) => {
	const icons = {
		...
		error: <XCircle className="text-danger me-2" size={20} />,
	};
	...
	return (
		<div
			className={t.visible ? 'animate-popup-enter' : 'animate-popup-leave'}
			style={{
			...
			<Toast
				...
				<Toast.Body className="pt-0 pb-3" style={{ paddingLeft: '40px' }}>
